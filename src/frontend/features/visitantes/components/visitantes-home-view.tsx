...
export function VisitantesHomeView({ permissions, role }: VisitantesHomeViewProps) {
      ...
      <Grid container spacing={2}>
        {canCadastrar && (
          <Grid size={{ xs: 12, sm: 6, md: 4 }}>
            <Link href="/visitantes/novo" style={{ textDecoration: "none", display: "block", height: "100%" }}>
              <Card sx={{ height: "100%" }}>
        ...
        {canListar && (
          <Grid size={{ xs: 12, sm: 6, md: 4 }}>
            <Link href="/visitantes/listagem" style={{ textDecoration: "none", display: "block", height: "100%" }}>
              <Card sx={{ height: "100%" }}>
                <CardActionArea sx={{ height: "100%" }}>
                  <CardContent sx={{ textAlign: "center", py: 4 }}>
                    <ListIcon sx={{ fontSize: 48, color: "primary.main", mb: 1 }} />
                    <Typography variant="h6" sx={{ fontWeight: 700 }}>
                      Listar Visitantes
                    </Typography>
                    <Typography variant="body2" color="text.secondary">
