...
vi.mock(
  "@/modules/visitantes/repositories/find-visitante-by-id.repository",
  () => ({
    findVisitanteByIdRepository: (id: string) =>
      findVisitanteByIdRepositoryMock(id),
  }),
);

vi.mock("@/modules/visitantes/repositories/update-member.repository", () => ({
  updateMemberRepository: (...args: unknown[]) =>
    updateMemberRepositoryMock(...args),
}));

vi.mock(
  "@/modules/visitantes/repositories/update-member-visitor.repository",
  () => ({
    updateMemberVisitorRepository: (...args: unknown[]) =>
      updateMemberVisitorRepositoryMock(...args),
  }),
);

vi.mock(
  "@/modules/visitantes/repositories/find-member-prays-by-member-id.repository",
  () => ({
...
vi.mock(
  "@/modules/visitantes/repositories/delete-member-prays-by-member-id.repository",
  () => ({
...
vi.mock(
  "@/modules/visitantes/repositories/delete-prays-by-ids.repository",
  () => ({
    deletePraysByIdsRepository: (...args: unknown[]) =>
      deletePraysByIdsRepositoryMock(...args),
  }),
);

vi.mock(
  "@/modules/visitantes/repositories/find-member-relationship-by-id.repository",
  () => ({
...
vi.mock(
  "@/modules/visitantes/repositories/delete-member-relationship.repository",
  () => ({
...
vi.mock(
  "@/modules/visitantes/repositories/count-member-relationships-by-member-id.repository",
  () => ({
...
vi.mock(
  "@/modules/visitantes/repositories/update-member-relationship.repository",
  () => ({
...
vi.mock(
  "@/modules/visitantes/repositories/ensure-member-visitor-profile.repository",
  () => ({
...
describe("updateVisitanteService", () => {
  ...
  it("aplica operacao create para familiar", async () => {
    ...
    expect(updateMemberRepositoryMock).toHaveBeenCalledWith(
  ...
  it("aplica operacao unlink e garante perfil de visitante do familiar", async () => {
    ...
    expect(deleteMemberRelationshipRepositoryMock).toHaveBeenCalledWith(
      "rel-1",
      {},
    );
    expect(ensureMemberVisitorProfileRepositoryMock).toHaveBeenCalledWith(
      "member-2",
      {},
    );
  });
